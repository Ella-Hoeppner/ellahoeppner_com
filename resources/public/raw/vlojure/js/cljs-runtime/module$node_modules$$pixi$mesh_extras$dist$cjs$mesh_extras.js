...
this.shader.texture.height,geometry.update();_super.prototype._render.call(this,renderer)};return SimpleRope}(mesh.Mesh);require=function(_super){function SimplePlane(texture,verticesX,verticesY){verticesX=new PlaneGeometry(texture.width,texture.height,verticesX,verticesY);verticesY=new mesh.MeshMaterial(core.Texture.WHITE);verticesX=_super.call(this,verticesX,verticesY)||this;verticesX.texture=texture;verticesX.autoResize=!0;return verticesX}__extends(SimplePlane,_super);SimplePlane.prototype.textureUpdated=
function(){this._textureID=this.shader.texture._updateID;var geometry=this.geometry,_a=this.shader.texture,width=_a.width;_a=_a.height;!this.autoResize||geometry.width===width&&geometry.height===_a||(geometry.width=this.shader.texture.width,geometry.height=this.shader.texture.height,geometry.build())};Object.defineProperty(SimplePlane.prototype,"texture",{get:function(){return this.shader.texture},set:function(value){if(this.shader.texture!==value)if(this.shader.texture=value,this._textureID=-1,value.baseTexture.valid)this.textureUpdated();
else value.once("update",this.textureUpdated,this)},enumerable:!1,configurable:!0});SimplePlane.prototype._render=function(renderer){this._textureID!==this.shader.texture._updateID&&this.textureUpdated();_super.prototype._render.call(this,renderer)};SimplePlane.prototype.destroy=function(options){this.shader.texture.off("update",this.textureUpdated,this);_super.prototype.destroy.call(this,options)};return SimplePlane}(mesh.Mesh);module=function(_super){function SimpleMesh(texture,vertices,uvs,indices,
drawMode){void 0===texture&&(texture=core.Texture.EMPTY);vertices=new mesh.MeshGeometry(vertices,uvs,indices);vertices.getBuffer("aVertexPosition").static=!1;texture=new mesh.MeshMaterial(texture);drawMode=_super.call(this,vertices,texture,null,drawMode)||this;drawMode.autoUpdate=!0;return drawMode}__extends(SimpleMesh,_super);Object.defineProperty(SimpleMesh.prototype,"vertices",{get:function(){return this.geometry.getBuffer("aVertexPosition").data},set:function(value){this.geometry.getBuffer("aVertexPosition").data=
value},enumerable:!1,configurable:!0});SimpleMesh.prototype._render=function(renderer){this.autoUpdate&&this.geometry.getBuffer("aVertexPosition").update();_super.prototype._render.call(this,renderer)};return SimpleMesh}(mesh.Mesh);var NineSlicePlane=function(_super){function NineSlicePlane(texture,leftWidth,topHeight,rightWidth,bottomHeight){void 0===leftWidth&&(leftWidth=10);void 0===topHeight&&(topHeight=10);void 0===rightWidth&&(rightWidth=10);void 0===bottomHeight&&(bottomHeight=10);var _this=
_super.call(this,core.Texture.WHITE,4,4)||this;_this._origWidth=texture.orig.width;_this._origHeight=texture.orig.height;_this._width=_this._origWidth;_this._height=_this._origHeight;_this._leftWidth=leftWidth;_this._rightWidth=rightWidth;_this._topHeight=topHeight;_this._bottomHeight=bottomHeight;_this.texture=texture;return _this}__extends(NineSlicePlane,_super);NineSlicePlane.prototype.textureUpdated=function(){this._textureID=this.shader.texture._updateID;this._refresh()};Object.defineProperty(NineSlicePlane.prototype,
"vertices",{get:function(){return this.geometry.getBuffer("aVertexPosition").data},set:function(value){this.geometry.getBuffer("aVertexPosition").data=value},enumerable:!1,configurable:!0});NineSlicePlane.prototype.updateHorizontalVertices=function(){var vertices=this.vertices,scale=this._getMinScale();vertices[9]=vertices[11]=vertices[13]=vertices[15]=this._topHeight*scale;vertices[17]=vertices[19]=vertices[21]=vertices[23]=this._height-this._bottomHeight*scale;vertices[25]=vertices[27]=vertices[29]=
vertices[31]=this._height};NineSlicePlane.prototype.updateVerticalVertices=function(){var vertices=this.vertices,scale=this._getMinScale();vertices[2]=vertices[10]=vertices[18]=vertices[26]=this._leftWidth*scale;vertices[4]=vertices[12]=vertices[20]=vertices[28]=this._width-this._rightWidth*scale;vertices[6]=vertices[14]=vertices[22]=vertices[30]=this._width};NineSlicePlane.prototype._getMinScale=function(){var w=this._leftWidth+this._rightWidth,h=this._topHeight+this._bottomHeight;return Math.min(this._width>
w?1:this._width/w,this._height>h?1:this._height/h)};Object.defineProperty(NineSlicePlane.prototype,"width",{get:function(){return this._width},set:function(value){this._width=value;this._refresh()},enumerable:!1,configurable:!0});Object.defineProperty(NineSlicePlane.prototype,"height",{get:function(){return this._height},set:function(value){this._height=value;this._refresh()},enumerable:!1,configurable:!0});Object.defineProperty(NineSlicePlane.prototype,"leftWidth",{get:function(){return this._leftWidth},
set:function(value){this._leftWidth=value;this._refresh()},enumerable:!1,configurable:!0});Object.defineProperty(NineSlicePlane.prototype,"rightWidth",{get:function(){return this._rightWidth},set:function(value){this._rightWidth=value;this._refresh()},enumerable:!1,configurable:!0});Object.defineProperty(NineSlicePlane.prototype,"topHeight",{get:function(){return this._topHeight},set:function(value){this._topHeight=value;this._refresh()},enumerable:!1,configurable:!0});Object.defineProperty(NineSlicePlane.prototype,
"bottomHeight",{get:function(){return this._bottomHeight},set:function(value){this._bottomHeight=value;this._refresh()},enumerable:!1,configurable:!0});NineSlicePlane.prototype._refresh=function(){var texture=this.texture,uvs=this.geometry.buffers[1].data;this._origWidth=texture.orig.width;this._origHeight=texture.orig.height;texture=1/this._origWidth;var _uvh=1/this._origHeight;uvs[0]=uvs[8]=uvs[16]=uvs[24]=0;uvs[1]=uvs[3]=uvs[5]=uvs[7]=0;uvs[6]=uvs[14]=uvs[22]=uvs[30]=1;uvs[25]=uvs[27]=uvs[29]=
uvs[31]=1;uvs[2]=uvs[10]=uvs[18]=uvs[26]=texture*this._leftWidth;uvs[4]=uvs[12]=uvs[20]=uvs[28]=1-texture*this._rightWidth;uvs[9]=uvs[11]=uvs[13]=uvs[15]=_uvh*this._topHeight;uvs[17]=uvs[19]=uvs[21]=uvs[23]=1-_uvh*this._bottomHeight;this.updateHorizontalVertices();this.updateVerticalVertices();this.geometry.buffers[0].update();this.geometry.buffers[1].update()};return NineSlicePlane}(require);exports.NineSlicePlane=NineSlicePlane;exports.PlaneGeometry=PlaneGeometry;exports.RopeGeometry=RopeGeometry;
exports.SimpleMesh=module;exports.SimplePlane=require;exports.SimpleRope=global}
