...
var digit_62079 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_62080__$1 = (vlq >>> (5));
while(true){
if((vlq_62080__$1 > (0))){
var digit_62081__$1 = (digit_62079 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_62081__$1));

var G__62083 = (vlq_62080__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__62084 = (vlq_62080__$1 >>> (5));
digit_62079 = G__62083;
vlq_62080__$1 = G__62084;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_62079));
}
break;
}
...
var G__62096 = i__$1;
var G__62097 = result__$1;
var G__62098 = shift__$1;
i = G__62096;
result = G__62097;
shift = G__62098;
continue;
