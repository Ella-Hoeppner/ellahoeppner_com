...
displayObject===eventData.stopsPropagatingAt)if(eventData.currentTarget=displayObject,eventData.type=eventString,displayObject.emit(eventString,eventData),displayObject[eventString])displayObject[eventString](eventData)};InteractionManager.prototype.delayDispatchEvent=function(displayObject,eventString,eventData){this.delayedEvents.push({displayObject:displayObject,eventString:eventString,eventData:eventData})};InteractionManager.prototype.mapPositionToPoint=function(point,x,y){var rect=this.interactionDOMElement.parentElement?
...
displayObject,func,hitTest);func=this.delayedEvents;if(!func.length)return displayObject;interactionEvent.stopPropagationHint=!1;interactionEvent=func.length;this.delayedEvents=[];for(hitTest=0;hitTest<interactionEvent;hitTest++){var _a=func[hitTest],displayObject_1=_a.displayObject,eventString=_a.eventString;_a=_a.eventData;_a.stopsPropagatingAt===displayObject_1&&(_a.stopPropagationHint=!0);this.dispatchEvent(displayObject_1,eventString,_a)}return displayObject};InteractionManager.prototype.onPointerDown=
function(originalEvent){if(!this.supportsTouchEvents||"touch"!==originalEvent.pointerType){var events=this.normalizeToPointerData(originalEvent);this.autoPreventDefault&&events[0].isNormalized&&(!originalEvent.cancelable&&"cancelable"in originalEvent||originalEvent.preventDefault());for(var eventLen=events.length,i=0;i<eventLen;i++){var event=events[i],interactionData=this.getInteractionDataForPointerId(event);interactionData=this.configureInteractionEventForDOMEvent(this.eventData,event,interactionData);
interactionData.data.originalEvent=originalEvent;this.processInteractive(interactionData,this.lastObjectRendered,this.processPointerDown,!0);this.emit("pointerdown",interactionData);"touch"===event.pointerType?this.emit("touchstart",interactionData):("mouse"===event.pointerType||"pen"===event.pointerType)&&this.emit(2===event.button?"rightdown":"mousedown",this.eventData)}}};InteractionManager.prototype.processPointerDown=function(interactionEvent,displayObject,hit){var data=interactionEvent.data,
id=interactionEvent.data.identifier;if(hit)if(displayObject.trackedPointers[id]||(displayObject.trackedPointers[id]=new InteractionTrackingData(id)),this.dispatchEvent(displayObject,"pointerdown",interactionEvent),"touch"===data.pointerType)this.dispatchEvent(displayObject,"touchstart",interactionEvent);else if("mouse"===data.pointerType||"pen"===data.pointerType)(hit=2===data.button)?displayObject.trackedPointers[id].rightDown=!0:displayObject.trackedPointers[id].leftDown=!0,this.dispatchEvent(displayObject,
hit?"rightdown":"mousedown",interactionEvent)};InteractionManager.prototype.onPointerComplete=function(originalEvent,cancelled,func){for(var events=this.normalizeToPointerData(originalEvent),eventLen=events.length,eventAppend=originalEvent.target!==this.interactionDOMElement?"outside":"",i=0;i<eventLen;i++){var event=events[i],interactionData=this.getInteractionDataForPointerId(event);interactionData=this.configureInteractionEventForDOMEvent(this.eventData,event,interactionData);interactionData.data.originalEvent=
originalEvent;this.processInteractive(interactionData,this.lastObjectRendered,func,cancelled||!eventAppend);this.emit(cancelled?"pointercancel":"pointerup"+eventAppend,interactionData);"mouse"===event.pointerType||"pen"===event.pointerType?this.emit(2===event.button?"rightup"+eventAppend:"mouseup"+eventAppend,interactionData):"touch"===event.pointerType&&(this.emit(cancelled?"touchcancel":"touchend"+eventAppend,interactionData),this.releaseInteractionDataForPointerId(event.pointerId))}};InteractionManager.prototype.onPointerCancel=
function(event){if(!this.supportsTouchEvents||"touch"!==event.pointerType)this.onPointerComplete(event,!0,this.processPointerCancel)};InteractionManager.prototype.processPointerCancel=function(interactionEvent,displayObject){var data=interactionEvent.data,id=interactionEvent.data.identifier;void 0!==displayObject.trackedPointers[id]&&(delete displayObject.trackedPointers[id],this.dispatchEvent(displayObject,"pointercancel",interactionEvent),"touch"===data.pointerType&&this.dispatchEvent(displayObject,
"touchcancel",interactionEvent))};InteractionManager.prototype.onPointerUp=function(event){if(!this.supportsTouchEvents||"touch"!==event.pointerType)this.onPointerComplete(event,!1,this.processPointerUp)};InteractionManager.prototype.processPointerUp=function(interactionEvent,displayObject,hit){var data=interactionEvent.data,id=interactionEvent.data.identifier,trackingData=displayObject.trackedPointers[id],isTouch="touch"===data.pointerType,isMouse="mouse"===data.pointerType||"pen"===data.pointerType,
isMouseTap=!1;if(isMouse){data=2===data.button;var flags=InteractionTrackingData.FLAGS;flags=data?flags.RIGHT_DOWN:flags.LEFT_DOWN;flags=void 0!==trackingData&&trackingData.flags&flags;hit?(this.dispatchEvent(displayObject,data?"rightup":"mouseup",interactionEvent),flags&&(this.dispatchEvent(displayObject,data?"rightclick":"click",interactionEvent),isMouseTap=!0)):flags&&this.dispatchEvent(displayObject,data?"rightupoutside":"mouseupoutside",interactionEvent);trackingData&&(data?trackingData.rightDown=
!1:trackingData.leftDown=!1)}hit?(this.dispatchEvent(displayObject,"pointerup",interactionEvent),isTouch&&this.dispatchEvent(displayObject,"touchend",interactionEvent),trackingData&&(isMouse&&!isMouseTap||this.dispatchEvent(displayObject,"pointertap",interactionEvent),isTouch&&(this.dispatchEvent(displayObject,"tap",interactionEvent),trackingData.over=!1))):trackingData&&(this.dispatchEvent(displayObject,"pointerupoutside",interactionEvent),isTouch&&this.dispatchEvent(displayObject,"touchendoutside",
interactionEvent));trackingData&&trackingData.none&&delete displayObject.trackedPointers[id]};InteractionManager.prototype.onPointerMove=function(originalEvent){if(!this.supportsTouchEvents||"touch"!==originalEvent.pointerType){var events=this.normalizeToPointerData(originalEvent);if("mouse"===events[0].pointerType||"pen"===events[0].pointerType)this._didMove=!0,this.cursor=null;for(var eventLen=events.length,i=0;i<eventLen;i++){var event=events[i],interactionData=this.getInteractionDataForPointerId(event);
interactionData=this.configureInteractionEventForDOMEvent(this.eventData,event,interactionData);interactionData.data.originalEvent=originalEvent;this.processInteractive(interactionData,this.lastObjectRendered,this.processPointerMove,!0);this.emit("pointermove",interactionData);"touch"===event.pointerType&&this.emit("touchmove",interactionData);"mouse"!==event.pointerType&&"pen"!==event.pointerType||this.emit("mousemove",interactionData)}"mouse"===events[0].pointerType&&this.setCursorMode(this.cursor)}};
InteractionManager.prototype.processPointerMove=function(interactionEvent,displayObject,hit){var data=interactionEvent.data,isTouch="touch"===data.pointerType;(data="mouse"===data.pointerType||"pen"===data.pointerType)&&this.processPointerOverOut(interactionEvent,displayObject,hit);if(!this.moveWhenInside||hit)this.dispatchEvent(displayObject,"pointermove",interactionEvent),isTouch&&this.dispatchEvent(displayObject,"touchmove",interactionEvent),data&&this.dispatchEvent(displayObject,"mousemove",interactionEvent)};
InteractionManager.prototype.onPointerOut=function(originalEvent){if(!this.supportsTouchEvents||"touch"!==originalEvent.pointerType){originalEvent=this.normalizeToPointerData(originalEvent)[0];"mouse"===originalEvent.pointerType&&(this.mouseOverRenderer=!1,this.setCursorMode(null));var interactionData=this.getInteractionDataForPointerId(originalEvent),interactionEvent=this.configureInteractionEventForDOMEvent(this.eventData,originalEvent,interactionData);interactionEvent.data.originalEvent=originalEvent;
this.processInteractive(interactionEvent,this.lastObjectRendered,this.processPointerOverOut,!1);this.emit("pointerout",interactionEvent);"mouse"===originalEvent.pointerType||"pen"===originalEvent.pointerType?this.emit("mouseout",interactionEvent):this.releaseInteractionDataForPointerId(interactionData.identifier)}};InteractionManager.prototype.processPointerOverOut=function(interactionEvent,displayObject,hit){var data=interactionEvent.data,id=interactionEvent.data.identifier;data="mouse"===data.pointerType||
"pen"===data.pointerType;var trackingData=displayObject.trackedPointers[id];hit&&!trackingData&&(trackingData=displayObject.trackedPointers[id]=new InteractionTrackingData(id));void 0!==trackingData&&(hit&&this.mouseOverRenderer?(trackingData.over||(trackingData.over=!0,this.delayDispatchEvent(displayObject,"pointerover",interactionEvent),data&&this.delayDispatchEvent(displayObject,"mouseover",interactionEvent)),data&&null===this.cursor&&(this.cursor=displayObject.cursor)):trackingData.over&&(trackingData.over=
!1,this.dispatchEvent(displayObject,"pointerout",this.eventData),data&&this.dispatchEvent(displayObject,"mouseout",interactionEvent),trackingData.none&&delete displayObject.trackedPointers[id]))};InteractionManager.prototype.onPointerOver=function(originalEvent){originalEvent=this.normalizeToPointerData(originalEvent)[0];var interactionData=this.getInteractionDataForPointerId(originalEvent);interactionData=this.configureInteractionEventForDOMEvent(this.eventData,originalEvent,interactionData);interactionData.data.originalEvent=
originalEvent;"mouse"===originalEvent.pointerType&&(this.mouseOverRenderer=!0);this.emit("pointerover",interactionData);"mouse"!==originalEvent.pointerType&&"pen"!==originalEvent.pointerType||this.emit("mouseover",interactionData)};InteractionManager.prototype.getInteractionDataForPointerId=function(event){var pointerId=event.pointerId;if(1===pointerId||"mouse"===event.pointerType)var interactionData=this.mouse;else this.activeInteractionData[pointerId]?interactionData=this.activeInteractionData[pointerId]:
