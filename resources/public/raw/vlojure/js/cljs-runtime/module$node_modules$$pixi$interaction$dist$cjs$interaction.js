...
_this.processPointerOverOut=_this.processPointerOverOut.bind(_this);_this.onPointerOver=_this.onPointerOver.bind(_this);_this.cursorStyles={default:"inherit",pointer:"pointer"};_this.currentCursorMode=null;_this.cursor=null;_this.resolution=1;_this.delayedEvents=[];_this.search=new TreeSearch;_this._tempDisplayObject=new display.TemporaryDisplayObject;_this._useSystemTicker=void 0!==options.useSystemTicker?options.useSystemTicker:!0;_this.setTargetElement(_this.renderer.view,_this.renderer.resolution);
return _this}__extends(InteractionManager,_super);Object.defineProperty(InteractionManager.prototype,"useSystemTicker",{get:function(){return this._useSystemTicker},set:function(useSystemTicker){(this._useSystemTicker=useSystemTicker)?this.addTickerListener():this.removeTickerListener()},enumerable:!1,configurable:!0});Object.defineProperty(InteractionManager.prototype,"lastObjectRendered",{get:function(){return this.renderer._lastObjectRendered||this._tempDisplayObject},enumerable:!1,configurable:!0});
InteractionManager.prototype.hitTest=function(globalPoint,root){hitTestEvent.target=null;hitTestEvent.data.global=globalPoint;root||(root=this.lastObjectRendered);this.processInteractive(hitTestEvent,root,null,!0);return hitTestEvent.target};InteractionManager.prototype.setTargetElement=function(element,resolution){void 0===resolution&&(resolution=1);this.removeTickerListener();this.removeEvents();this.interactionDOMElement=element;this.resolution=resolution;this.addEvents();this.addTickerListener()};
InteractionManager.prototype.addTickerListener=function(){!this.tickerAdded&&this.interactionDOMElement&&this._useSystemTicker&&(ticker.Ticker.system.add(this.tickerUpdate,this,ticker.UPDATE_PRIORITY.INTERACTION),this.tickerAdded=!0)};InteractionManager.prototype.removeTickerListener=function(){this.tickerAdded&&(ticker.Ticker.system.remove(this.tickerUpdate,this),this.tickerAdded=!1)};InteractionManager.prototype.addEvents=function(){if(!this.eventsAdded&&this.interactionDOMElement){var style=this.interactionDOMElement.style;
self.navigator.msPointerEnabled?(style.msContentZooming="none",style.msTouchAction="none"):this.supportsPointerEvents&&(style.touchAction="none");this.supportsPointerEvents?(self.document.addEventListener("pointermove",this.onPointerMove,!0),this.interactionDOMElement.addEventListener("pointerdown",this.onPointerDown,!0),this.interactionDOMElement.addEventListener("pointerleave",this.onPointerOut,!0),this.interactionDOMElement.addEventListener("pointerover",this.onPointerOver,!0),self.addEventListener("pointercancel",
this.onPointerCancel,!0),self.addEventListener("pointerup",this.onPointerUp,!0)):(self.document.addEventListener("mousemove",this.onPointerMove,!0),this.interactionDOMElement.addEventListener("mousedown",this.onPointerDown,!0),this.interactionDOMElement.addEventListener("mouseout",this.onPointerOut,!0),this.interactionDOMElement.addEventListener("mouseover",this.onPointerOver,!0),self.addEventListener("mouseup",this.onPointerUp,!0));this.supportsTouchEvents&&(this.interactionDOMElement.addEventListener("touchstart",
this.onPointerDown,!0),this.interactionDOMElement.addEventListener("touchcancel",this.onPointerCancel,!0),this.interactionDOMElement.addEventListener("touchend",this.onPointerUp,!0),this.interactionDOMElement.addEventListener("touchmove",this.onPointerMove,!0));this.eventsAdded=!0}};InteractionManager.prototype.removeEvents=function(){if(this.eventsAdded&&this.interactionDOMElement){var style=this.interactionDOMElement.style;self.navigator.msPointerEnabled?(style.msContentZooming="",style.msTouchAction=
""):this.supportsPointerEvents&&(style.touchAction="");this.supportsPointerEvents?(self.document.removeEventListener("pointermove",this.onPointerMove,!0),this.interactionDOMElement.removeEventListener("pointerdown",this.onPointerDown,!0),this.interactionDOMElement.removeEventListener("pointerleave",this.onPointerOut,!0),this.interactionDOMElement.removeEventListener("pointerover",this.onPointerOver,!0),self.removeEventListener("pointercancel",this.onPointerCancel,!0),self.removeEventListener("pointerup",
this.onPointerUp,!0)):(self.document.removeEventListener("mousemove",this.onPointerMove,!0),this.interactionDOMElement.removeEventListener("mousedown",this.onPointerDown,!0),this.interactionDOMElement.removeEventListener("mouseout",this.onPointerOut,!0),this.interactionDOMElement.removeEventListener("mouseover",this.onPointerOver,!0),self.removeEventListener("mouseup",this.onPointerUp,!0));this.supportsTouchEvents&&(this.interactionDOMElement.removeEventListener("touchstart",this.onPointerDown,!0),
this.interactionDOMElement.removeEventListener("touchcancel",this.onPointerCancel,!0),this.interactionDOMElement.removeEventListener("touchend",this.onPointerUp,!0),this.interactionDOMElement.removeEventListener("touchmove",this.onPointerMove,!0));this.interactionDOMElement=null;this.eventsAdded=!1}};InteractionManager.prototype.tickerUpdate=function(deltaTime){this._deltaTime+=deltaTime;this._deltaTime<this.interactionFrequency||(this._deltaTime=0,this.update())};InteractionManager.prototype.update=
function(){if(this.interactionDOMElement)if(this._didMove)this._didMove=!1;else{this.cursor=null;for(var k in this.activeInteractionData)if(this.activeInteractionData.hasOwnProperty(k)){var interactionData=this.activeInteractionData[k];interactionData.originalEvent&&"touch"!==interactionData.pointerType&&(interactionData=this.configureInteractionEventForDOMEvent(this.eventData,interactionData.originalEvent,interactionData),this.processInteractive(interactionData,this.lastObjectRendered,this.processPointerOverOut,
!0))}this.setCursorMode(this.cursor)}};InteractionManager.prototype.setCursorMode=function(mode){mode=mode||"default";var applyStyles=!0;self.OffscreenCanvas&&this.interactionDOMElement instanceof OffscreenCanvas&&(applyStyles=!1);if(this.currentCursorMode!==mode){this.currentCursorMode=mode;var style=this.cursorStyles[mode];if(style)switch(typeof style){case "string":applyStyles&&(this.interactionDOMElement.style.cursor=style);break;case "function":style(mode);break;case "object":applyStyles&&Object.assign(this.interactionDOMElement.style,
style)}else applyStyles&&"string"===typeof mode&&!Object.prototype.hasOwnProperty.call(this.cursorStyles,mode)&&(this.interactionDOMElement.style.cursor=mode)}};InteractionManager.prototype.dispatchEvent=function(displayObject,eventString,eventData){if(!eventData.stopPropagationHint||displayObject===eventData.stopsPropagatingAt)if(eventData.currentTarget=displayObject,eventData.type=eventString,displayObject.emit(eventString,eventData),displayObject[eventString])displayObject[eventString](eventData)};
InteractionManager.prototype.delayDispatchEvent=function(displayObject,eventString,eventData){this.delayedEvents.push({displayObject:displayObject,eventString:eventString,eventData:eventData})};InteractionManager.prototype.mapPositionToPoint=function(point,x,y){var rect=this.interactionDOMElement.parentElement?this.interactionDOMElement.getBoundingClientRect():{x:0,y:0,width:this.interactionDOMElement.width,height:this.interactionDOMElement.height,left:0,top:0};var resolutionMultiplier=1/this.resolution;
point.x=this.interactionDOMElement.width/rect.width*(x-rect.left)*resolutionMultiplier;point.y=this.interactionDOMElement.height/rect.height*(y-rect.top)*resolutionMultiplier};InteractionManager.prototype.processInteractive=function(interactionEvent,displayObject,func,hitTest){displayObject=this.search.findHit(interactionEvent,displayObject,func,hitTest);func=this.delayedEvents;if(!func.length)return displayObject;interactionEvent.stopPropagationHint=!1;interactionEvent=func.length;this.delayedEvents=
[];for(hitTest=0;hitTest<interactionEvent;hitTest++){var _a=func[hitTest],displayObject_1=_a.displayObject,eventString=_a.eventString;_a=_a.eventData;_a.stopsPropagatingAt===displayObject_1&&(_a.stopPropagationHint=!0);this.dispatchEvent(displayObject_1,eventString,_a)}return displayObject};InteractionManager.prototype.onPointerDown=function(originalEvent){if(!this.supportsTouchEvents||"touch"!==originalEvent.pointerType){var events=this.normalizeToPointerData(originalEvent);this.autoPreventDefault&&
events[0].isNormalized&&(!originalEvent.cancelable&&"cancelable"in originalEvent||originalEvent.preventDefault());for(var eventLen=events.length,i=0;i<eventLen;i++){var event=events[i],interactionData=this.getInteractionDataForPointerId(event);interactionData=this.configureInteractionEventForDOMEvent(this.eventData,event,interactionData);interactionData.data.originalEvent=originalEvent;this.processInteractive(interactionData,this.lastObjectRendered,this.processPointerDown,!0);this.emit("pointerdown",
interactionData);"touch"===event.pointerType?this.emit("touchstart",interactionData):("mouse"===event.pointerType||"pen"===event.pointerType)&&this.emit(2===event.button?"rightdown":"mousedown",this.eventData)}}};InteractionManager.prototype.processPointerDown=function(interactionEvent,displayObject,hit){var data=interactionEvent.data,id=interactionEvent.data.identifier;if(hit)if(displayObject.trackedPointers[id]||(displayObject.trackedPointers[id]=new InteractionTrackingData(id)),this.dispatchEvent(displayObject,
"pointerdown",interactionEvent),"touch"===data.pointerType)this.dispatchEvent(displayObject,"touchstart",interactionEvent);else if("mouse"===data.pointerType||"pen"===data.pointerType)(hit=2===data.button)?displayObject.trackedPointers[id].rightDown=!0:displayObject.trackedPointers[id].leftDown=!0,this.dispatchEvent(displayObject,hit?"rightdown":"mousedown",interactionEvent)};InteractionManager.prototype.onPointerComplete=function(originalEvent,cancelled,func){for(var events=this.normalizeToPointerData(originalEvent),
eventLen=events.length,eventAppend=originalEvent.target!==this.interactionDOMElement?"outside":"",i=0;i<eventLen;i++){var event=events[i],interactionData=this.getInteractionDataForPointerId(event);interactionData=this.configureInteractionEventForDOMEvent(this.eventData,event,interactionData);interactionData.data.originalEvent=originalEvent;this.processInteractive(interactionData,this.lastObjectRendered,func,cancelled||!eventAppend);this.emit(cancelled?"pointercancel":"pointerup"+eventAppend,interactionData);
"mouse"===event.pointerType||"pen"===event.pointerType?this.emit(2===event.button?"rightup"+eventAppend:"mouseup"+eventAppend,interactionData):"touch"===event.pointerType&&(this.emit(cancelled?"touchcancel":"touchend"+eventAppend,interactionData),this.releaseInteractionDataForPointerId(event.pointerId))}};InteractionManager.prototype.onPointerCancel=function(event){if(!this.supportsTouchEvents||"touch"!==event.pointerType)this.onPointerComplete(event,!0,this.processPointerCancel)};InteractionManager.prototype.processPointerCancel=
function(interactionEvent,displayObject){var data=interactionEvent.data,id=interactionEvent.data.identifier;void 0!==displayObject.trackedPointers[id]&&(delete displayObject.trackedPointers[id],this.dispatchEvent(displayObject,"pointercancel",interactionEvent),"touch"===data.pointerType&&this.dispatchEvent(displayObject,"touchcancel",interactionEvent))};InteractionManager.prototype.onPointerUp=function(event){if(!this.supportsTouchEvents||"touch"!==event.pointerType)this.onPointerComplete(event,!1,
this.processPointerUp)};InteractionManager.prototype.processPointerUp=function(interactionEvent,displayObject,hit){var data=interactionEvent.data,id=interactionEvent.data.identifier,trackingData=displayObject.trackedPointers[id],isTouch="touch"===data.pointerType,isMouse="mouse"===data.pointerType||"pen"===data.pointerType,isMouseTap=!1;if(isMouse){data=2===data.button;var flags=InteractionTrackingData.FLAGS;flags=data?flags.RIGHT_DOWN:flags.LEFT_DOWN;flags=void 0!==trackingData&&trackingData.flags&
flags;hit?(this.dispatchEvent(displayObject,data?"rightup":"mouseup",interactionEvent),flags&&(this.dispatchEvent(displayObject,data?"rightclick":"click",interactionEvent),isMouseTap=!0)):flags&&this.dispatchEvent(displayObject,data?"rightupoutside":"mouseupoutside",interactionEvent);trackingData&&(data?trackingData.rightDown=!1:trackingData.leftDown=!1)}hit?(this.dispatchEvent(displayObject,"pointerup",interactionEvent),isTouch&&this.dispatchEvent(displayObject,"touchend",interactionEvent),trackingData&&
(isMouse&&!isMouseTap||this.dispatchEvent(displayObject,"pointertap",interactionEvent),isTouch&&(this.dispatchEvent(displayObject,"tap",interactionEvent),trackingData.over=!1))):trackingData&&(this.dispatchEvent(displayObject,"pointerupoutside",interactionEvent),isTouch&&this.dispatchEvent(displayObject,"touchendoutside",interactionEvent));trackingData&&trackingData.none&&delete displayObject.trackedPointers[id]};InteractionManager.prototype.onPointerMove=function(originalEvent){if(!this.supportsTouchEvents||
"touch"!==originalEvent.pointerType){var events=this.normalizeToPointerData(originalEvent);if("mouse"===events[0].pointerType||"pen"===events[0].pointerType)this._didMove=!0,this.cursor=null;for(var eventLen=events.length,i=0;i<eventLen;i++){var event=events[i],interactionData=this.getInteractionDataForPointerId(event);interactionData=this.configureInteractionEventForDOMEvent(this.eventData,event,interactionData);interactionData.data.originalEvent=originalEvent;this.processInteractive(interactionData,
this.lastObjectRendered,this.processPointerMove,!0);this.emit("pointermove",interactionData);"touch"===event.pointerType&&this.emit("touchmove",interactionData);"mouse"!==event.pointerType&&"pen"!==event.pointerType||this.emit("mousemove",interactionData)}"mouse"===events[0].pointerType&&this.setCursorMode(this.cursor)}};InteractionManager.prototype.processPointerMove=function(interactionEvent,displayObject,hit){var data=interactionEvent.data,isTouch="touch"===data.pointerType;(data="mouse"===data.pointerType||
"pen"===data.pointerType)&&this.processPointerOverOut(interactionEvent,displayObject,hit);if(!this.moveWhenInside||hit)this.dispatchEvent(displayObject,"pointermove",interactionEvent),isTouch&&this.dispatchEvent(displayObject,"touchmove",interactionEvent),data&&this.dispatchEvent(displayObject,"mousemove",interactionEvent)};InteractionManager.prototype.onPointerOut=function(originalEvent){if(!this.supportsTouchEvents||"touch"!==originalEvent.pointerType){originalEvent=this.normalizeToPointerData(originalEvent)[0];
"mouse"===originalEvent.pointerType&&(this.mouseOverRenderer=!1,this.setCursorMode(null));var interactionData=this.getInteractionDataForPointerId(originalEvent),interactionEvent=this.configureInteractionEventForDOMEvent(this.eventData,originalEvent,interactionData);interactionEvent.data.originalEvent=originalEvent;this.processInteractive(interactionEvent,this.lastObjectRendered,this.processPointerOverOut,!1);this.emit("pointerout",interactionEvent);"mouse"===originalEvent.pointerType||"pen"===originalEvent.pointerType?
this.emit("mouseout",interactionEvent):this.releaseInteractionDataForPointerId(interactionData.identifier)}};InteractionManager.prototype.processPointerOverOut=function(interactionEvent,displayObject,hit){var data=interactionEvent.data,id=interactionEvent.data.identifier;data="mouse"===data.pointerType||"pen"===data.pointerType;var trackingData=displayObject.trackedPointers[id];hit&&!trackingData&&(trackingData=displayObject.trackedPointers[id]=new InteractionTrackingData(id));void 0!==trackingData&&
(hit&&this.mouseOverRenderer?(trackingData.over||(trackingData.over=!0,this.delayDispatchEvent(displayObject,"pointerover",interactionEvent),data&&this.delayDispatchEvent(displayObject,"mouseover",interactionEvent)),data&&null===this.cursor&&(this.cursor=displayObject.cursor)):trackingData.over&&(trackingData.over=!1,this.dispatchEvent(displayObject,"pointerout",this.eventData),data&&this.dispatchEvent(displayObject,"mouseout",interactionEvent),trackingData.none&&delete displayObject.trackedPointers[id]))};
InteractionManager.prototype.onPointerOver=function(originalEvent){originalEvent=this.normalizeToPointerData(originalEvent)[0];var interactionData=this.getInteractionDataForPointerId(originalEvent);interactionData=this.configureInteractionEventForDOMEvent(this.eventData,originalEvent,interactionData);interactionData.data.originalEvent=originalEvent;"mouse"===originalEvent.pointerType&&(this.mouseOverRenderer=!0);this.emit("pointerover",interactionData);"mouse"!==originalEvent.pointerType&&"pen"!==
originalEvent.pointerType||this.emit("mouseover",interactionData)};InteractionManager.prototype.getInteractionDataForPointerId=function(event){var pointerId=event.pointerId;if(1===pointerId||"mouse"===event.pointerType)var interactionData=this.mouse;else this.activeInteractionData[pointerId]?interactionData=this.activeInteractionData[pointerId]:(interactionData=this.interactionDataPool.pop()||new InteractionData,interactionData.identifier=pointerId,this.activeInteractionData[pointerId]=interactionData);
interactionData.copyEvent(event);return interactionData};InteractionManager.prototype.releaseInteractionDataForPointerId=function(pointerId){var interactionData=this.activeInteractionData[pointerId];interactionData&&(delete this.activeInteractionData[pointerId],interactionData.reset(),this.interactionDataPool.push(interactionData))};InteractionManager.prototype.configureInteractionEventForDOMEvent=function(interactionEvent,pointerEvent,interactionData){interactionEvent.data=interactionData;this.mapPositionToPoint(interactionData.global,
pointerEvent.clientX,pointerEvent.clientY);"touch"===pointerEvent.pointerType&&(pointerEvent.globalX=interactionData.global.x,pointerEvent.globalY=interactionData.global.y);interactionData.originalEvent=pointerEvent;interactionEvent.reset();return interactionEvent};InteractionManager.prototype.normalizeToPointerData=function(event){var normalizedEvents=[];if(this.supportsTouchEvents&&event instanceof TouchEvent)for(var i=0,li=event.changedTouches.length;i<li;i++){var touch=event.changedTouches[i];
"undefined"===typeof touch.button&&(touch.button=event.touches.length?1:0);"undefined"===typeof touch.buttons&&(touch.buttons=event.touches.length?1:0);"undefined"===typeof touch.isPrimary&&(touch.isPrimary=1===event.touches.length&&"touchstart"===event.type);"undefined"===typeof touch.width&&(touch.width=touch.radiusX||1);"undefined"===typeof touch.height&&(touch.height=touch.radiusY||1);"undefined"===typeof touch.tiltX&&(touch.tiltX=0);"undefined"===typeof touch.tiltY&&(touch.tiltY=0);"undefined"===
typeof touch.pointerType&&(touch.pointerType="touch");"undefined"===typeof touch.pointerId&&(touch.pointerId=touch.identifier||0);"undefined"===typeof touch.pressure&&(touch.pressure=touch.force||.5);"undefined"===typeof touch.twist&&(touch.twist=0);"undefined"===typeof touch.tangentialPressure&&(touch.tangentialPressure=0);"undefined"===typeof touch.layerX&&(touch.layerX=touch.offsetX=touch.clientX);"undefined"===typeof touch.layerY&&(touch.layerY=touch.offsetY=touch.clientY);touch.isNormalized=
...
(event.pointerId=1),"undefined"===typeof event.pressure&&(event.pressure=.5),"undefined"===typeof event.twist&&(event.twist=0),"undefined"===typeof event.tangentialPressure&&(event.tangentialPressure=0),event.isNormalized=!0;normalizedEvents.push(event)}return normalizedEvents};InteractionManager.prototype.destroy=function(){this.removeEvents();this.removeTickerListener();this.removeAllListeners();this.search=this.onPointerOver=this.processPointerOverOut=this.onPointerOut=this.processPointerMove=
this.onPointerMove=this.processPointerCancel=this.onPointerCancel=this.processPointerUp=this.onPointerUp=this.processPointerDown=this.onPointerDown=this.interactionDOMElement=this.eventData=this.mouse=this.renderer=null};return InteractionManager}(require.EventEmitter);exports.InteractionData=InteractionData;exports.InteractionEvent=InteractionEvent;exports.InteractionManager=require;exports.InteractionTrackingData=InteractionTrackingData;exports.interactiveTarget=global}
