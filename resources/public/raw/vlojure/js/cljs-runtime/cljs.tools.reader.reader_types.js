...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_46995 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_46995(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_46997 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_46997(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47001 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47001(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47005 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47005(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47007 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47007(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47011 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47011(reader);
}
});
...
var G__47123 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__47124 = s.append(c);
c = G__47123;
s = G__47124;
continue;
}
