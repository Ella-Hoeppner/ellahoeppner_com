...
var digit_47053 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_47054__$1 = (vlq >>> (5));
while(true){
if((vlq_47054__$1 > (0))){
var digit_47055__$1 = (digit_47053 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_47055__$1));

var G__47056 = (vlq_47054__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__47057 = (vlq_47054__$1 >>> (5));
digit_47053 = G__47056;
vlq_47054__$1 = G__47057;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_47053));
}
break;
}
...
var G__47063 = i__$1;
var G__47064 = result__$1;
var G__47065 = shift__$1;
i = G__47063;
result = G__47064;
shift = G__47065;
continue;
