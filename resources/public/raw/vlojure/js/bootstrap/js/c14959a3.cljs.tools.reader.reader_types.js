...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_47547 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_47547(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_47558 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_47558(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47571 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47571(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47578 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47578(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47590 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47590(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47599 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47599(reader);
}
});
...
var G__47814 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__47815 = s.append(c);
c = G__47814;
s = G__47815;
continue;
}
