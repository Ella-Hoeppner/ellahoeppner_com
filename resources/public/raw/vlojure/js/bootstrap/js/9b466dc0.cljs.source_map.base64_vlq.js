...
var digit_47197 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_47198__$1 = (vlq >>> (5));
while(true){
if((vlq_47198__$1 > (0))){
var digit_47200__$1 = (digit_47197 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_47200__$1));

var G__47202 = (vlq_47198__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__47203 = (vlq_47198__$1 >>> (5));
digit_47197 = G__47202;
vlq_47198__$1 = G__47203;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_47197));
}
break;
}
...
var G__47227 = i__$1;
var G__47228 = result__$1;
var G__47229 = shift__$1;
i = G__47227;
result = G__47228;
shift = G__47229;
continue;
