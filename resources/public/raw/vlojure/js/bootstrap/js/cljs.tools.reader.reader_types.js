...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_47006 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_47006(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_47015 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_47015(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47019 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_47019(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47024 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_47024(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47029 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_47029(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47035 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_47035(reader);
}
});
...
var G__47149 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__47150 = s.append(c);
c = G__47149;
s = G__47150;
continue;
}
