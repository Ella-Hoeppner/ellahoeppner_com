...
var digit_23805 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_23806__$1 = (vlq >>> (5));
while(true){
if((vlq_23806__$1 > (0))){
var digit_23807__$1 = (digit_23805 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_23807__$1));

var G__23808 = (vlq_23806__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__23809 = (vlq_23806__$1 >>> (5));
digit_23805 = G__23808;
vlq_23806__$1 = G__23809;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_23805));
}
break;
}
...
var G__23814 = i__$1;
var G__23815 = result__$1;
var G__23816 = shift__$1;
i = G__23814;
result = G__23815;
shift = G__23816;
continue;
