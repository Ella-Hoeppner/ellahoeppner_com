...
var G__24721 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__24721;
continue;
} else {
return ch;
...
var vec__24667 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24667,(0),null);
return (match === s);
});
...
var len__4736__auto___24779 = arguments.length;
var i__4737__auto___24780 = (0);
while(true){
if((i__4737__auto___24780 < len__4736__auto___24779)){
args__4742__auto__.push((arguments[i__4737__auto___24780]));

var G__24782 = (i__4737__auto___24780 + (1));
i__4737__auto___24780 = G__24782;
continue;
} else {
}
break;
...
return (function() { 
var G__24803__delegate = function (rdr,_){
...
var G__24803 = function (rdr,var_args){
var _ = null;
...
while (G__24804__i < G__24804__a.length) {G__24804__a[G__24804__i] = arguments[G__24804__i + 1]; ++G__24804__i;}
  _ = new cljs.core.IndexedSeq(G__24804__a,0,null);
} 
return G__24803__delegate.call(this,rdr,_);};
G__24803.cljs$lang$maxFixedArity = 1;
G__24803.cljs$lang$applyTo = (function (arglist__24807){
var rdr = cljs.core.first(arglist__24807);
var _ = cljs.core.rest(arglist__24807);
return G__24803__delegate(rdr,_);
});
