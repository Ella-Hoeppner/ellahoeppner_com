...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_24187 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_24187(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_24198 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_24198(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24210 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24210(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24224 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24224(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24236 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24236(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24248 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24248(reader);
}
});
...
var G__24420 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__24421 = s.append(c);
c = G__24420;
s = G__24421;
continue;
}
